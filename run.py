...
if __name__ == '__main__':
    ...
    argparser.add_argument('--action', type=str, default='train',
                           help='what action to take (train, test, eval)')
    #학습을 시킬때는 config를 써야한다.
    argparser.add_argument('-c', '--config', default='config.json', type=str,
    ...
    argparser.add_argument('--cfg', default='crnn.cfg', type=str,
    ...
    if args.config:
        ...
        config['cfg'] = args.cfg
    elif args.resume: #inference할 때 이거 사용
